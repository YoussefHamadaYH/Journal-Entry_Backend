...
namespace JournyTask.AutoMapper
{
    public class MappingProfile:Profile
    {
        public MappingProfile()
        {
            ...
            //CreateMap<JournalDetail, JournalDetailDTO>()
            //.ForMember(dest => dest.AccountName, opt => opt.MapFrom(src => src.Account.NameEn))
            //.ForMember(dest => dest.AccountNumber, opt => opt.MapFrom(src => src.Account.Number)).ReverseMap();
            ...
            //.ForMember(dest => dest.JournalDetails, opt => opt.MapFrom(src => src.JournalDetails)).ReverseMap();
